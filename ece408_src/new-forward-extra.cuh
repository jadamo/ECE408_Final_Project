...
// This file will store an implimentation of an EXTRA optimization so that we can get some 
// extra credit (I'm thinking adding streams to the host code would be a good idea)
